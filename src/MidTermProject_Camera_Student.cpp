...
int main(int argc, const char *argv[])
{
    ...
    for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex++)
    {
        ...
        if (dataBuffer.size() > 1) // wait until at least two images have been processed
        {
            ...
            matchDescriptors(dataBuffer[dataBuffer.size() - 2].keypoints, dataBuffer[dataBuffer.size() - 1].keypoints,
                             dataBuffer[dataBuffer.size() - 2].descriptors, dataBuffer[dataBuffer.size() - 1].descriptors,
            ...
            if (bVis)
            {
                ...
                cv::drawMatches(dataBuffer[dataBuffer.size() - 2].cameraImg, dataBuffer[dataBuffer.size() - 2].keypoints,
                                dataBuffer[dataBuffer.size() - 1].cameraImg, dataBuffer[dataBuffer.size() - 1].keypoints,
                                matches, matchImg,
